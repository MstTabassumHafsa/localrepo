...
if(isset($_GET['delete'])){
    ...
    $delete_image_query = mysqli_query($conn, "SELECT image FROM `donates` WHERE id = '$delete_id'") or die('query failed'); 
    $fetch_delete_image = mysqli_fetch_assoc($delete_image_query);
    unlink('uploaded_img/'.$fetch_delete_image['image']);
    mysqli_query($conn, "DELETE FROM `donates` WHERE id = '$delete_id'") or die('query failed');
    header('location:admin_exchange_book.php');
}
    ...
    <div class="box-container">
        ...
        <?php
            ...
            <div class="box">
                ...
                <a href="admin_exchange_book.php?delete=<?php echo $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('delete this products');" >delete</a>
