...
<section class="add-products">
    ...
    <h1 class="title">Donate books</h1>
    ...
    <input type="number" min="0" name="price" class="box" placeholder="enter delivery charge for requesting the book" required>
    <input type="file" name="image" accept="image/jpg, image/png, image/jpeg" class="box" required>
    <input type="submit" value="donate" name="add_product" class="btn">
